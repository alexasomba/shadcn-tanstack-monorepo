          ...
          <div key={guitar.id}>
            ...
            >
              <article className="demo-card h-full overflow-hidden p-0 transition hover:-translate-y-0.5">
                ...
                <div className="p-5">
                  <h2 className="mb-2 text-xl font-bold text-[var(--sea-ink)]">{guitar.name}</h2>
                  <p className="demo-muted mb-3 line-clamp-2">{guitar.shortDescription}</p>
                  <div className="text-xl font-bold text-[var(--lagoon-deep)]">${guitar.price}</div>
                </div>
              </article>
            </Link>
          </div>
