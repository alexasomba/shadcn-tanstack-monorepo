...
function createToast(
  titleOrOptions: React.ReactNode | ToastAddOptions,
  ...
  if (
    ...
    return toastManager.add(titleOrOptions as ToastAddOptions);
  }
...
const toast = Object.assign(createToast, toastManager, {
  success: (title: React.ReactNode, options?: ToastHelperOptions) =>
    toastManager.add({ title, description: options?.description, type: "success", ...options }),
  error: (title: React.ReactNode, options?: ToastHelperOptions) =>
    toastManager.add({ title, description: options?.description, type: "error", ...options }),
  info: (title: React.ReactNode, options?: ToastHelperOptions) =>
    toastManager.add({ title, description: options?.description, type: "info", ...options }),
  warning: (title: React.ReactNode, options?: ToastHelperOptions) =>
    toastManager.add({ title, description: options?.description, type: "warning", ...options }),
  loading: (title: React.ReactNode, options?: ToastHelperOptions) =>
    toastManager.add({ title, description: options?.description, type: "loading", ...options }),
});
