...
export const InlineToast: FC<InlineCopyToastProps> = ({ code, copyDuration = 2000 }) => {
  ...
  return (
    <motion.div
      ...
      className="relative flex h-16 min-w-[320px] items-center justify-center overflow-hidden rounded-full border border-[#ecebeb2b] bg-[#F6F6F6] pr-2 pl-7 shadow-sm dark:bg-zinc-900"
    >
      <AnimatePresence>
        {copied && (
          <motion.div
