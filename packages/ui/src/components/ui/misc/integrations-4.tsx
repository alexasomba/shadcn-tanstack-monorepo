...
const integrations = [
  ...
  {
    title: "Slack",
    description: "Communicate instantly and keep everyone aligned in real time.",
    icon: SiSlack,
  },
  {
    title: "Stripe",
  ...
  {
    title: "Figma",
    description: "Design, prototype, and collaborate on interfaces in real time.",
    icon: Figma,
  },
];
...
export default function Integrations4() {
  return (
    <section className="relative w-full bg-background px-4 py-20 md:py-32">
      <div className="mx-auto max-w-5xl">
        <div className="mb-14 flex flex-col items-center gap-5 text-center">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground">
            Discover integrations that connect your favorite apps, improve productivity, and keep
            your work in sync.
          </p>
        </div>

        <div className="overflow-hidden rounded-none border bg-background shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08),0px_1px_2px_-1px_rgba(0,0,0,0.08),0px_2px_4px_0px_rgba(0,0,0,0.06)]">
          <div className="grid grid-cols-1 gap-px rounded-none bg-border md:grid-cols-3">
            {integrations.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-md leading-tighter font-medium text-muted-foreground">
                    {item.description}
                  </p>
                </div>
              );
