...
export const StepIndicator = ({ steps, tooltipDelay = 0, onStepChange }: StepIndicatorProps) => {
  ...
  return (
    <div className="flex w-full items-center justify-center px-4 py-20">
      <div className="w-full max-w-[420px]">
        <div className="relative flex h-3 w-full items-center gap-3 px-1" onMouseLeave={handleHide}>
          <AnimatePresence>
