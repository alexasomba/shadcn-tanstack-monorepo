...
export default function FamilyWallet() {
  ...
  const PasskeyView = () => (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="p relative flex items-center justify-center rounded-2xl bg-white dark:bg-zinc-800">
        <div className="pointer-events-none absolute inset-0">
          <svg className="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <rect x="1" y="1" width="98" height="98" rx="16" ry="16" fill="none" stroke="none" />
            =
            <motion.rect
              x="1"
              y="1"
      ...
      <button
        onClick={() => setView(View.SIGN_IN)}
        className="w-full cursor-pointer rounded-xl bg-blue-500 py-3 text-white"
      >
        Continue
      </button>
    </div>
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        {[
          ...
          <button
            key={i}
            className="flex w-full cursor-pointer items-center justify-between rounded-xl bg-white p-4 dark:bg-zinc-800"
            onClick={() => setView(View.SIGN_IN)}
          >
        ...
        <button className="flex w-full items-center justify-between rounded-xl bg-white p-4 dark:bg-zinc-800">
          <div className="flex items-center gap-2">
            <span className="text-zinc-900 dark:text-zinc-100">Other Wallets</span>
            <div className="rounded-full border border-zinc-200 bg-zinc-100 px-3 text-lg dark:border-zinc-700 dark:bg-zinc-800/50">
              350+
            </div>
          </div>
  ...
  return (
    <div className="relative flex items-center justify-center">
      <button
        ...
        className="rounded-full bg-zinc-100 px-8 py-4 font-bold dark:bg-zinc-800 dark:text-white"
      >
        Open Wallet
      </button>
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        <DrawerPortal>
          ...
          <DrawerContent className="fixed bottom-10! mx-auto w-[360px] overflow-hidden rounded-4xl! border border-zinc-100 bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900">
            <motion.div
