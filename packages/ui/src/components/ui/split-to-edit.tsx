...
export const SplitToEdit: FC<SplitToEditProps> = ({
  ...
  return (
    <MotionConfig transition={isExpanded ? layoutConfig : collapsedConfig}>
      <motion.div layout className={cn("flex items-center font-mono", isExpanded && "gap-4")}>
        <motion.div
          layout
          animate={{
        ...
        >
          <motion.input
            ...
            className="h-10 w-[2ch] bg-transparent text-center font-mono text-xl font-semibold text-neutral-900 outline-none dark:text-zinc-200"
          />
        ...
        <motion.div
          ...
          className={cn(
            "flex cursor-pointer items-center justify-end gap-1 bg-zinc-100 px-1 will-change-transform dark:bg-zinc-800",
            isExpanded && "gap-5 px-3",
          )}
          onClick={!isExpanded ? handleEdit : undefined}
        >
          <motion.input
            ...
            readOnly={!isExpanded}
            onKeyDown={handleKeyPress}
            className="h-10 w-[2ch] bg-transparent text-center font-mono text-xl font-semibold text-zinc-900 outline-none dark:text-zinc-200"
          />
        ...
        <motion.div
          ...
          className="flex h-10 w-10 items-center justify-center bg-zinc-100 will-change-transform dark:bg-zinc-800"
        >
          <button onClick={isExpanded ? handleSave : handleEdit} className="cursor-pointer">
